...
.PHONY: build test test-pharaoh test-peridot-pharaoh-oracle test-pharaoh-fork check-pharaoh-safe-batches grow-pharaoh-observations check-pharaoh-observations deploy-pharaoh-dry-run deploy-pharaoh-mainnet deploy-pharaoh-upgrade-dry-run deploy-pharaoh-upgrade-mainnet prepare-pharaoh-upgrade deploy-pharaoh-hotfix-dry-run deploy-pharaoh-hotfix-mainnet prepare-pharaoh-hotfix fund-pharaoh-small-stage-dry-run fund-pharaoh-small-stage-mainnet pharaoh-status pharaoh-pnl-snapshot test-lfj-fork test-lfj-fork-pinned deploy-lfj-proxy-dry-run deploy-lfj-proxy-mainnet deploy-lfj-dry-run deploy-lfj-mainnet check-lfj apy-snapshot apy-compare
